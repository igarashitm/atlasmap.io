...
gulp.task('css:watch', gulp.series('css', function () {
  gulp.watch('./themes/atlasmap/scss/**/*.scss', gulp.series('css'));
}));

gulp.task('js', function () {
  return gulp.src(jsLibs)
    .pipe(plugins.concat('atlasmap.js'))
    .pipe(gulp.dest('./themes/atlasmap/static/js'));
});
...
gulp.task('fonts', function() {
  return gulp.src('./node_modules/font-awesome/fonts/*')
    .pipe(gulp.dest('./themes/atlasmap/static/fonts'))
});
